...
const guidelines = [
  ...
  <>Manuscript must be <strong>4 to 6 pages</strong> in IEEE format with similarity index limited to <strong>15%</strong> (single source similarity must be less than 3%).</>,
