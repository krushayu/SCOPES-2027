    ...
    <div className="comm-container">
      ...
      <div className="comm-content">
        {committees.map((committee) => (
          <div className="comm-section" key={committee.id} style={{ '--accent': committee.color }}>
            <div className="comm-header" style={{ borderLeftColor: committee.color }}>
              <div className="comm-color-dot" style={{ backgroundColor: committee.color }}></div>
              <h2 className="comm-section-title">{committee.title}</h2>
              <span className="comm-count">{committee.members.length} member{committee.members.length > 1 ? 's' : ''}</span>
            </div>
            <div className="comm-members">
              {committee.members.map((member, index) => (
                <div className="comm-member" key={index}>
                  <div className="comm-member-index" style={{ backgroundColor: committee.color }}>{index + 1}</div>
